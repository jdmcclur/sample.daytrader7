...
public class TradeAction implements TradeServices {
    ...
    public OrderDataBean buy(String userID, String symbol, double quantity, int orderProcessingMode) throws Exception {
        ...
        updateQuotePriceVolume(symbol, TradeConfig.getRandomPriceChangeFactor("buy"), quantity);
    ...
    public OrderDataBean sell(String userID, Integer holdingID, int orderProcessingMode) throws Exception {
        ...
        if (!orderData.getOrderStatus().equalsIgnoreCase("cancelled")) {
            updateQuotePriceVolume(orderData.getSymbol(), TradeConfig.getRandomPriceChangeFactor("sell"), orderData.getQuantity());
        }
